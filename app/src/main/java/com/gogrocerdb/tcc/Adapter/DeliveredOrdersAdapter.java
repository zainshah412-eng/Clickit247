...
public class DeliveredOrdersAdapter extends RecyclerView.Adapter<DeliveredOrdersAdapter.MyViewHolder> {
    ...
    public DeliveredOrdersAdapter(Context context, List<My_order_model> modemodelList, final Fragment currentFragment) {
...
//
    ...
    public DeliveredOrdersAdapter(List<My_order_model> modelList) {
    ...
    public DeliveredOrdersAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DeliveredOrdersAdapter.MyViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(DeliveredOrdersAdapter.MyViewHolder holder, int position) {
